...
variable "enable_tailscale_exit_node" {
  type    = bool
  default = false
}
...
variable "tailscale_state_secret_name" {
  type    = string
  default = "tailscale"
}

variable "tailscale_exit_node_name" {
  type    = string
  default = "tailscale-exit-node"
}

variable "tailscale_exit_node_hostname" {
  type    = string
  default = "oci-oke-exit-node"
}
